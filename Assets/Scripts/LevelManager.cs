...
public class LevelManager : MonoBehaviour
{
    ...
    void enemyWave(GameObject enemy, int amountEnemies)
    {
        ...
        for (int i = 0; i < amountEnemies; i++)
        {
            ...
            {
                case 0: //top
                    spawnPos = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(UnityEngine.Random.Range(0f, 1f), 1.5f, 100f));
                    break;
                case 1: //right
                    spawnPos = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(1.5f, UnityEngine.Random.Range(0f, 1f), 100f));
                    break;
                case 2: //bottom
                    spawnPos = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(UnityEngine.Random.Range(0f, 1f), -0.5f, 100f));
                    break;
                case 3: //left
                    spawnPos = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(-0.5f, UnityEngine.Random.Range(0f, 1f), 100f));
                    break;
            }
